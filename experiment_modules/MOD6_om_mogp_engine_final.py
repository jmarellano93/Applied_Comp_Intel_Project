...
# WHAT IT DOES: Establishes the massive computational dimensions required to
#     explore the symbolic meta-feature space deeply enough to guarantee global optima.
# PARAMETERS: population_size (100), generations (20), datasets_per_rule (20).
# METHODOLOGICAL JUSTIFICATION: Because fitness evaluation requires full
...
# WHAT IT DOES: Dynamically maps the target directory to save the discovered equations.
# PARAMETERS: N/A (Implicit OS lookup).
# METHODOLOGICAL JUSTIFICATION: Prevents absolute path crashes across varied
...
# =============================================================================
# FUNCTIONAL BLOCK: Resume-From-Disk Consensus Reconstruction
# WHAT IT IS: The recovery path that rebuilds a consensus front from previously
#     written per-run artifacts.
# WHAT IT DOES: Lets a multi-day sweep that was aggregated separately reassemble
#     its consensus without re-running discovery.
# HOW IT DOES IT: _rebuild_individual_from_strings re-parses stored equation
#     strings into typed individuals; aggregate_consensus_from_disk reads the
#     per-run archive files and delegates to the same string-keyed averaging
#     used by the in-memory aggregator.
# =============================================================================
